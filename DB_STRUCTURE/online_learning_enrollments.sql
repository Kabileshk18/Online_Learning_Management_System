...
CREATE TABLE `enrollments` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `enrollments_studentId_courseId_unique` (`studentId`,`courseId`),
  KEY `courseId` (`courseId`),
  CONSTRAINT `enrollments_ibfk_1` FOREIGN KEY (`studentId`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
...
-- Dump completed on 2025-03-04 12:25:02
